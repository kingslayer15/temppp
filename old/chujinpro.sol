...
interface SwapService {
     function swapFcrAndBurn(uint256 amountIn) external returns (uint256);
}
...
contract GiveMoney {
    ...
    function setSwapAdd(address changeSwapAdd) public  {
    ...
    bytes32  r,bytes32  s,bytes1  v) public {
        ...
        if (servicefee >0){
            ...
            initconfig.swapService.swapFcrAndBurn(servicefee);
        }
